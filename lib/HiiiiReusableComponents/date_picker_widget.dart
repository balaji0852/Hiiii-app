...
import 'package:Hiiii/HiiiiReusableComponents/extra/color.dart';
import 'package:Hiiii/HiiiiReusableComponents/extra/style.dart';
import 'package:Hiiii/HiiiiReusableComponents/gestures/tap.dart';
...
class _DatePickerState extends State<DatePicker> {
  ...
  void initState() {
    ...
    this.selectedDateStyle =
        createTextStyle(widget.dateTextStyle, Colors.black);
    this.selectedMonthStyle =
        createTextStyle(widget.monthTextStyle, Colors.black);
    this.selectedDayStyle = createTextStyle(widget.dayTextStyle, Colors.black);

    this.deactivatedDateStyle =
        createTextStyle(widget.dateTextStyle, Colors.white);
    this.deactivatedMonthStyle =
        createTextStyle(widget.monthTextStyle, Colors.white);
    this.deactivatedDayStyle =
        createTextStyle(widget.dayTextStyle, Colors.white);
...
//            print("Inside Inactive dates.");
          ...
          return DateWidget(
            ...
            selectionColor:
                isSelected ? HexColor('#8FFF29') : Colors.transparent,
